...
export const teachersData = [
  {
    ...
    email: 'john@doe.com',
    photo:
      'https://images.pexels.com/photos/2888200/pexels-photo-2888150.jpeg?auto=compress&cs=tinysrgb&w=1200',
    phone: '1234567890',
...
export const calendarEvents = [
  {
    ...
    end: new Date('2024-12-16T08:45:00'),
  },
  {
    title: 'English',
    allDay: false,
    start: new Date('2024-12-16T09:00'),
    end: new Date('2024-12-16T09:45'),
  },
  {
    title: 'Biology',
    allDay: false,
    start: new Date('2024-12-16T10:00'),
    end: new Date('2024-12-16T10:45'),
  },
  {
    title: 'Physics',
    allDay: false,
    start: new Date('2024-12-16T11:00'),
    end: new Date('2024-12-16T11:45'),
  },
  {
    title: 'Chemistry',
    allDay: false,
    start: new Date('2024-12-16T13:00'),
    end: new Date('2024-12-16T13:45'),
  },
  {
    title: 'English',
    allDay: false,
    start: new Date('2024-12-18T09:00'),
    end: new Date('2024-12-18T09:45'),
  },
  {
    title: 'Biology',
    allDay: false,
    start: new Date('2024-12-18T10:00'),
    end: new Date('2024-12-18T10:45'),
  },
  {
    title: 'Physics',
    allDay: false,
    start: new Date('2024-12-18T11:00'),
    end: new Date('2024-12-18T11:45'),
  },

  {
    title: 'History',
    allDay: false,
    start: new Date('2024-12-18T14:00'),
    end: new Date('2024-12-18T14:45'),
  },
  {
    title: 'Math',
    allDay: false,
    start: new Date('2024-12-19T08:00'),
    end: new Date('2024-12-19T08:45'),
  },
  {
    title: 'Biology',
    allDay: false,
    start: new Date('2024-12-19T10:00'),
    end: new Date('2024-12-19T10:45'),
  },

  {
    title: 'Chemistry',
    allDay: false,
    start: new Date('2024-12-19T13:00'),
    end: new Date('2024-12-19T13:45'),
  },
  {
    title: 'History',
    allDay: false,
    start: new Date('2024-12-19T14:00'),
    end: new Date('2024-12-19T14:45'),
  },
  {
    title: 'English',
    allDay: false,
    start: new Date('2024-12-20T09:00'),
    end: new Date('2024-12-20T09:45'),
  },
  {
    title: 'Biology',
    allDay: false,
    start: new Date('2024-12-20T10:00'),
    end: new Date('2024-12-20T10:45'),
  },
  {
    title: 'Physics',
    allDay: false,
    start: new Date('2024-12-20T11:00'),
    end: new Date('2024-12-20T11:45'),
  },

  {
    title: 'History',
    allDay: false,
    start: new Date('2024-12-20T14:00'),
    end: new Date('2024-12-20T14:45'),
  },
  {
    title: 'Math',
    allDay: false,
    start: new Date('2024-12-17T08:00'),
    end: new Date('2024-12-17T08:45'),
  },
  {
    title: 'English',
    allDay: false,
    start: new Date('2024-12-17T09:00'),
    end: new Date('2024-12-17T09:45'),
  },

  {
    title: 'Physics',
    allDay: false,
    start: new Date('2024-12-17T11:00'),
    end: new Date('2024-12-17T11:45'),
  },
  {
    title: 'Chemistry',
    allDay: false,
    start: new Date('2024-12-17T13:00'),
    end: new Date('2024-12-17T13:45'),
  },
  {
    title: 'History',
    allDay: false,
    start: new Date('2024-12-17T14:00'),
    end: new Date('2024-12-17T14:45'),
  },
];
